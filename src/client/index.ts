...
const WS_URL: string = 'wss://mail.shudo-physics.com:443';
...
let tokenBalances: Record<string, { balance: number; symbol: string; name: string }> = {};
...
function updateBalanceUI(): void {
  ...
  const tokenKeys: string[] = Object.keys(tokenBalances);
